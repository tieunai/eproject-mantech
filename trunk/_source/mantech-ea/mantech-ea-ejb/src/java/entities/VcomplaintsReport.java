...
@NamedQueries({
    ...
    @NamedQuery(name = "VcomplaintsReport.findByBetweenTime4", query = "SELECT v FROM VcomplaintsReport v WHERE v.departmentID = :departmentID AND v.threadID = :threadID AND v.userRef = :userRef AND v.createTime BETWEEN :start AND :end"),
